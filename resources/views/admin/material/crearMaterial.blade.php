...
<div class="col-md-10 " style="padding-bottom:80px">
  <form action="{{ route('admin.postCreateMaterial') }}" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group {{ ($errors->has('color')) == true ? ' has-danger bmd-form-group' : '' }}">
    ...
    <input type="text" class="form-control" id="demo1" name="color" readonly style="background-color:white;" value="{{ old('color') }}">
    @if ($errors->has('color'))
      <span class="form-control-feedback">
          <i class="material-icons">clear</i>
      </span>
